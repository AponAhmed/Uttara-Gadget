...
use Aponahmed\Uttaragedget\src\GmailApi;

/**
 * Description of Contact system with Gmail Apis Service
 *
 * @author Apon
 */
...
class ContactAdmin
{
    ...
    {
        wp_register_style('gApicontact-css', __UTTG_ASSETS . '/contact-admin-style.css', false, '1.0.0');
        wp_enqueue_style('gApicontact-css');
        wp_enqueue_script('gApicontact-scripts', __UTTG_ASSETS . '/contact-admin-scripts.js', array('jquery'), '1.0');
        wp_localize_script('gApicontact-scripts', 'ajax_object', array('ajax_url' => admin_url('admin-ajax.php')));
    }
