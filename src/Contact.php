...
use Aponahmed\Uttaragedget\src\ContactAdmin;
...
class Contact
{
    ...
    {
        wp_register_style('contact-css', __UTTG_ASSETS . 'contact-styles.css', false, '1.0.0');
        wp_enqueue_style('contact-css');

        wp_enqueue_script('contact-scripts', __UTTG_ASSETS . 'contact-script.js', array('jquery'), '1.0');
